...
# This script is great! I like how you step through the negative indices. You 
# could also have  used "range(-n_lines, 0)" to set "j" to each negative index.
# The code is super easy to reads and well commented, so keep that up. Overall,
# you seem to know exactly what you are doing. Keep it up! - Mike